import { useState } from 'react'; // Retirer React inutilisé
...
import type { UserType } from "../types"; // Ajouter l'import de UserType
import { 
  User, 
  Save, 
  Camera, 
  ...
  Plus,
  X
} from 'lucide-react'; // Retirer les imports inutilisés
import type {Page } from "../index";
// Utiliser le type Page depuis App.tsx ou le définir ici

interface AddPatientFormProps {
  onNavigate: (page: Page) => void;
  onLogout: () => void;
  userType: UserType | null; // Ajouter | null pour correspondre à App.tsx
}
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select onValueChange={(value: string) => handleInputChange('bloodType', value)}>
                      <SelectTrigger>
