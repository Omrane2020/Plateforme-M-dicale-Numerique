...
type Page = 'home' | 'login' | 'signup' | 'doctor-dashboard' | 'doctor-profile' | 'patient-management' | 'appointments' | 'patient-dashboard' | 'contact' | 'prescription' | 'secretary-dashboard' | 'secretary-management' | 'add-patient';
